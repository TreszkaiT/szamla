package com.tresz.szamla.configurations;

import com.tresz.szamla.views.login.LoginView;
...
@EnableWebSecurity
@Configuration
public class LoginSecurityConfig extends VaadinWebSecurityConfigurerAdapter {
    /**
