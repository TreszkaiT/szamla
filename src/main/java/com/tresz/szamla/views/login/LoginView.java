package com.tresz.szamla.views.login;
...
@Route("login")
@PageTitle("Login | Számla adatok bevitele")
public class LoginView extends VerticalLayout implements BeforeEnterListener {

    private LoginOverlay loginOverlay = new LoginOverlay();
    private ProductPropertyController propertyController;

    public LoginView(ProductPropertyController propertyController) {
        this.propertyController = propertyController;

        loginOverlay.setTitle("Számla adatok bevitele alkalmazás");
        loginOverlay.setDescription("v."+propertyController.getProductVersion());
